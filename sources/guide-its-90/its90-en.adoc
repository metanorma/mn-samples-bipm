...
An inverse function, equivalent to equation (10a) to within stem:[0.13 " mK"], is:
...
| stem:[A_2] | stem:[-1.801 43597] | stem:[B_2] | stem:[0.209108771]
...
| <<scls_3-3-2-4>> | stem:[156.598 5 " °C"] | As for <<scls_3-3-2>> with stem:[b = c = d = 0] | 9, 11
| <<scls_3-3-2-5>> | stem:[29.764 6 " °C"] | As for <<scls_3-3-2>> with stem:[b = c = d = 0] | 9, 10

4+| (c&#x200c;) Range from stem:[234.3156 " K"] (stem:[- 38.8344 " °C"]) to stem:[29.764 6 " °C"]
...
empowered to do so by the thirteenth Conférence Générale of 1967-
