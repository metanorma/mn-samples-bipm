...
The polynomial representations of the differences between ITS-90 and IPTS-68 from stem:[13.8 " K"] to stem:[903.8 " K"] (stem:[630.6 " °C"]) are due to R. L. Rusby [Rusby 1990] with the coefficients given in Table 3:
...
This domain covers practically the entire visible region of the spectrum; i.e., the listed values apply with negligible error at wavelengths near 0.65 µm up to about stem:[4000 " °C"]. At a wavelength of 1 µm and at higher temperatures, a wavelength dependence arising from the Planck equation (see Equation (15) of the text of the ITS-90) has to be considered.
