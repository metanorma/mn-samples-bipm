...
stem:[ii(sigma)]:: is the absorption cross-section of ozone at 253.7 nm under standard conditions of temperature and pressure, stem:[1.1476 xx 10^(−17)" "rm(cm)^2"/molecule"] <<ambient>>.
...
|===
.2+h| Component (stem:[y]) 4+^h| Uncertainty stem:[u(y)] .2+^h| Sensitivity coefficient stem:[c_i=(delta x)/(delta y)] .2+^h| contribution to stem:[u(x)] stem:[abs(c_i) * u(y)] nmol/mol
...
|===
^h| Nom value ^|  stem:[x_i] / (nmol/mol) ^|  stem:[u_i] / (nmol/mol) ^|  stem:[x_("SRP27")] / (nmol/mol) ^|  stem:[u_("SRP27")] / (nmol/mol) ^|  stem:[ii(D)_i] / (nmol/mol) ^|  stem:[u(ii(D)_i)] / (nmol/mol) ^|  stem:[ii(U)(ii(D)_i)] / (nmol/mol) 
...
The standard uncertainties on the parameters of the regression are stem:[u(a_1) = 0.0033] for the slope and stem:[u(a_0) = 0.22" "rm(nmol)//rm(mol)] for the intercept. The covariance between the two parameters is stem:["cov"(a_0, a_1) = −2.02 xx 10^(−4)" "rm(nmol)//rm(mol)].
