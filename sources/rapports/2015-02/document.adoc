...
stem:[sigma]:: is the absorption cross-section of ozone at stem:[253.7" "rm(nm)] under standard conditions of temperature and pressure, stem:[1.1476 xx 10^(−17)" "rm(cm)^2//"molecule"] <<iso13964>>;
...
The uncertainty budget for the ozone amount-of-substance fraction in dry air (stem:[x]) measured by the instruments BIPM-SRP27 and BIPM-SRP28 in the nominal range 0 nmol/mol to stem:[500" "rm(nmol)//rm(mol)] is given in <<table1>>.
...
|===
^h| Nom value ^h| stem:[x_i] / (nmol/mol) ^h| stem:[u_i] / (nmol/mol) ^h| stem:[x_("SRP27")] / (nmol/mol) ^h| stem:[u_("SRP27")] / (nmol/mol) ^h| stem:[ii(D)_i] / (nmol/mol) ^h| stem:[u(Di)] / (nmol/mol) ^h| stem:[U(Di)] / (nmol/mol)
...
The standard uncertainties on the parameters of the regression are stem:[u(a_1) = 0.0034] for the slope and stem:[u(a_0) = 0.31" "rm(nmol)//rm(mol)] for the intercept. The covariance between the two parameters is stem:[cov(a_0, a_1) = -3.73 xx 10^(–4)" "rm(nmol)//rm(mol)].
...
|===
| Nom value (nmol/mol) | stem:[ii(D)_i] (nmol/mol) | stem:[u(ii(D)_i)] (nmol/mol) | stem:[ii(U)(ii(D)_i)] (nmol/mol)
| 80 | 0.03 | 0.67 | 1.35
| 420 | 0.64 | 1.88 | 3.77
|===
...
|===
5+h| Differences
h| Point Number h| Nom value (nmol/mol) h| stem:[ii(D)_i] (nmol/mol) h| stem:[u(ii(D)_i)] (nmol/mol) h| stem:[ii(U)(ii(D)_i)] (nmol/mol)
...
h| Optical Path (stem:[ii(L)]) | 89.92 cm | BIPM | Rect | 0.520 cm | 0.520 cm ^.^| stem:[-x/(2 ii(L))] | 0.289%

.2+h| Pressure (stem:[ii(P)]) .2+.^| 101.325 kPa | Gauge | Rect | 0.077 kPa .2+.^| 0.086 kPa .2+^.^| stem:[-x/ii(P)] .2+.^| 0.085%
| Difference | Rect | 0.038 kPa

.2+h| Temperature (stem:[ii(T)]) .2+.^| 273.15 °K | Probe | Rect | 0.115 K .2+.^| 0.129 K .2+^.^| stem:[x/ii(T)] .2+.^| 0.047%
| Gradient | Rect | 0.058 °K
...
h| Absorption Cross Section (stem:[ii(alpha)]) | 308.32 cm^–1^ | Conventional Value | Rect | 1.732 cm^–1^ | 1.732 cm^–1^ ^.^| stem:[x/(ii(alpha))] | 0.562%
|===
