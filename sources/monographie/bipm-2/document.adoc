...
plus switching time of the order of stem:[10" "rm(mu) rm(s)] or more, and hence the method
...
a gating interval of stem:[25" "rm(mu) rm(s)]. A simple calculation shows that the method
...
[[fig5]]
.Measurement of the correlation function stem:[ii(R)(ii(tau))], for the approximate parameters stem:[ii(N)_("sing") = 2 500" "rm(s)^(-1)], stem:[ii(N)_("pair") = 0] or stem:[900" "rm(s)^(-1)] and stem:[ii(lambda)^(-1) -= ii(tau)_o = 10" "rm(mu) rm(s)].
image::img07.png[]
