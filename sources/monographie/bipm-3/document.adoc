...
stem:[18 "unitsml(kBq/ml)"]. Also by measuring ^3^H levels in blood samples and in urine at prescribed
...
to process up to stem:[12 "unitsml(g)"] of sample.
...
to radionuclides with maximum stem:[beta]-particle energies far below the stem:[0.26 "unitsml(MeV)"]
...
[[tableII-2]]
.Abbreviations, chemical formulae and wavelengths (stem:[ii(lambda)]) at fluorescence-emission maxima for organic scintillators referred to in this Monograph footnote:[Chemical structures for these scintillators, except for PPD and BIBUQ are given in Table 6 of <<ncr78>>.]
|===
h| Abbreviation ^h| Formula ^h| Fluorescence-emission +
maximum stem:[ii(lambda)] (nm)
...
in dispensing aqueous samples in the range stem:[20] to stem:[70 "unitsml(mg)"]. It is exceedingly difficult
...
of one litre) with a small sample (stem:[1] to stem:[5 "unitsml(g)"]). Aliquots of the large batch are then
...
First, about stem:[0.1 "unitsml(ml)"] of the aqueous sample (containing the radionuclide and appropriate
carriers) is weighed into an open stem:[100-"unitsml(ml)"] bottle. Then the sample is dissolved
in stem:[6 "unitsml(ml)"] of ethanol, stem:[44 "unitsml(ml)"] of toluene-based scintillator is added, and the bottle
...
these solutions would be that obtained on adding stem:[150 "unitsml(mg)"] of an aqueous solution of
stem:[4 "unitsml(mol)"] HCl per stem:["unitsml(dm^3)"] to stem:[10 "unitsml(ml)"] of solution (90% toluene-10% ethanol, by volume).
...
of stem:[10 "unitsml(nm)"] or less and, therefore, energy loss within the micelles will only be significant
...
In recent work at NBS, ^239^Pu solution samples (stem:[100] to stem:[300 "unitsml(mg)"] in an aqueous solution
of stem:[5 "unitsml(mol*l^-1)"] HNO~3~ were introduced directly into stem:[10 "unitsml(ml)"] of a commercial emulsion
...
the surfactant <<ben76>>, while others find that warming the sample to stem:[40 "unitsml(degC)"] reduces
...
[[figII-2]]
.Loss in count rate observed for some ^89^Sr counting samples prepared using a commercial emulsion scintillator. Measurements were made at stem:[6 "unitsml(degC)"] using a Packard TriCarb, with a window fixed by a single low-level discriminator. The counting efficiency in this window was 0.995. The counting samples consisted of stem:[~~ 75 "unitsml(mg)"] of aqueous solution (SrCl~2~ in an aqueous solution of stem:[0.1 "unitsml(mol)"] HCl per stem:["unitsml(dm^3)") in stem:[15 "unitsml(ml)"] of emulsion scintillator in borosilicate-glass vials (from measurements made at NBS).
image::img06.png[]

[[figII-3]]
.Relative loss in count rate due to sample adsorption for ten counting samples containing different amounts of strontium carrier and chelating agent: &#9702; strontium only, &#8226; strontium stem:[+ 0.2 "unitsml(mmol)"] HDEHP. Each vial contained stem:[~~ 75 "unitsml(ml)"] of aqueous sample in stem:[7 "unitsml(ml)"] of a commercial emulsion scintillator (from measurements made at NBS).
image::img07.png[]
...
was then prepared and stem:[1 "unitsml(mg)"] of strontium per stem:[7 "unitsml(ml)"] of emulsion was found
...
these for design purposes is the figure of merit, stem:[ii(eta)] <<swa58>>, <<bir64-1>>, which is
the number of photoelectrons arriving at the first dynode per kiloelectronvolt
of energy deposited in the scintillator. By way of comparison stem:[ii(eta)] is of the order
of 6 photoelectrons/keV for a conventional stem:[7.6 xx 7.6 "unitsml(cm)"] Nal(Tl) detector,
while for a single-phototube LS system stem:[ii(eta)]. will be between 0.2 and 2 photoelectrons/keV depending on the design of the system. In the second part of this
section we consider methods of optimizing stem:[ii(eta)], and finally a review is given on
...
counting efficiency for the two tubes in coincidence, stem:[ii(epsilon)](^3^H), for a so-called
...
found stem:[ii(epsilon)](^3^H) ranged from 42% to 57%. Presumably these values were slightly
low because air-saturated samples were used. With unquenched standards the
manufacturers usually claim to obtain stem:[ii(epsilon)](^3^H) of 60 to 65%.
...
* "Minivials" have an outer diameter of stem:[14 "unitsml(mm)"], and fit inside glass holders which have essentially the same dimensions as the larger vials. pass:p[ +]
...
informative to specify the figure of merit stem:[ii(eta)] for the counting system. The relationship
between stem:[ii(epsilon)](^3^H) and stem:[ii(eta)_0], the merit figure uncorrected for ionization quenching,
...
fall in the region on the left of the figure. To reach stem:[ii(epsilon)](^3^H) in excess of 70%,
...
[[figIII-2]]
.Comparison of figure of merit stem:[ii(eta)_0] and ^3^H counting efficiency from Gibson and Marshall <<gib72-2>> and Gibson <<gib79>>.
image::img09.png[]
...
. Kolarov et al. <<kol70>> reported stem:[ii(epsilon)](^3^H) = 73% for ^3^H-toluene in unquenched samples in a system specially designed to give high counting efficiency.

Before proceeding one other figure of merit should be mentioned, namely
stem:[ii(epsilon)(""^3"H")^2//ii(B)]; where stem:[ii(B)] is the background count rate expressed in counts per minute.
A good value for a commercial system would be stem:[ii(epsilon)(""^3"H")^2//ii(B) = 250], where
stem:[ii(epsilon)(""^3"H") = 62%] and stem:[ii(B) = 15.4] counts per minute. Although it is clearly desirable
...
or energy. For example, below approximately stem:[10 "unitsml(keV)"], the background will include
...
In the region above stem:[10 "unitsml(keV)"], stem:[ii(B)] depends on shielding, construction materials used
...
Although stem:[ii(eta)] is a function of electron energy (stem:[ii(E)_"e"]), it is convenient to describe the
system response arbitrarily for 5-keV monoenergetic electrons. In the remainder of
this discussion, stem:[ii(eta)] values will be for stem:[ii(E)_"e" = 5 "unitsml(keV)"] unless otherwise stated.

Following the treatment of Birks <<bir64-1>>, <<bir70>>, <<eqIII-3-1>> gives stem:[ii(eta)_"E"]
...
[stem]
++++
ii(eta)_"E" = ([(ii(S)_"e"*ii(E)_"e")/(h bar(ii(nu)))] [ii(G)] [m ii(C)_"pe" g_"c"])/(ii(E)_"e"),
++++

where

stem:[ii(S)_"E"]:: scintillation yield, the fraction of electron energy which is converted to light energy <<hor74-3>>,
stem:[h bar(ii(nu))]:: average energy of emitted photons,
stem:[ii(G)]:: light-collection efficiency, that fraction of the photons generated in step <<st-a>> that arrive at the photocathode,
stem:[m ii(C)_"pe" g_"c"]:: phototube response, the fraction of photons arriving at the photocathode, which result in photoelectrons arriving at the first dynode,
...
stem:[ii(C)_"pe"]:: maximum photoelectric efficiency of the photocathode, also called the "quantum efficiency", and
stem:[g_"c"]:: photoelectron-collection efficiency at the first dynode.

<<eqIII-3-1>> is interesting from a design standpoint because all three terms
in brackets have to be optimized to obtain values of stem:[ii(eta)_0] in excess of 1 photoelectron/keV. The first term is a function of the chemical composition of the
...
limit direct measurements of stem:[ii(S)_"E"] are:
...
expression giving stem:[ii(S)_"E"] as a function of stem:[ii(E)_"e"]. Using their value of stem:[ii(S)_"E" = 0.04] for
stem:[5 "unitsml(keV)"], and comparative data for different solvents <<bir64-1>>, <<bir75>> one would
expect stem:[ii(S)_"e" ~~ 0.045] for p-xylene with an efficient scintillator such as PPO or
t-butyl PBD. Using stem:[3.2 "unitsml(eV)"] as the average photon energy (stem:[385 "unitsml(nm)"]), one finds
that a 5-keV electron will produce 71 primary photons. This is the first term in
brackets in <<eqIII-3-1>>.

==== Light-collection efficiency

Estimates of the fraction stem:[ii(G)] of these
...
stem:[ii(G)] we will discuss some of the design factors that must be considered in optimizing
...
was varied from stem:[0.2] to stem:[5 "unitsml(cm)"].
...
Q2-3067" for which stem:[n_"D"= 1.4648].
...
[%unnumbered]
|===
.2+| Scintillator 2+| Relative pulse height .2+| stem:[ii(lambda)_("max") "unitsml(nm)"]
| Al | TiO~2~
| TP | 0.91 | 0.76 | 342
| PPO | 1.02 | 0.97 | 375
| POPOP | 1.21 | 1.45 | 415
...
stem:[n_"D" = 1.50] and a kinematic viscosity of stem:[1.15 "unitsml(cm^2*s^-1)"] <<dow79>>.
...
a quantitative estimate of stem:[ii(G)] to use in <<eqIII-3-1>>.

One could obtain estimates of stem:[ii(G)] using the Monte-Carlo calculations of Malcolm
...
arrangements, namely, for the IEC standard vial containing stem:[20 "unitsml(ml)"] of liquid scintillator,
and for a spherical vial containing, for example, stem:[5 "unitsml(ml)"] of scintillator.

Rather than use their estimates here we have elected to estimate all other parameters
in <<eqIII-3-1>> and then to solve for stem:[ii(G)] as the unknown. With this objective in mind
we consider now the phototube response.

==== Phototube response

The bracket term in <<eqIII-3-1>>, [ stem:[m" "ii(C)_"pe"" "g_"c"] ]
...
[stem]
++++
m = (int_0^(oo)ii(I)(ii(lambda)) ii(Phi)(ii(lambda)) "d"ii(lambda))/(int_0^(oo)ii(I)(ii(lambda))"d"ii(lambda)),
++++

where stem:[ii(I)(ii(lambda))] is the fluorescence spectrum of the scintillator, normalized such that stem:[int_0^(oo)ii(I)(ii(lambda))"d"ii(lambda) = 1], and stem:[ii(Phi)(ii(lambda))] is the photocathode response function, normalized such that the maximum value of stem:[ii(Phi)(ii(lambda))=1].
...
The second term stem:[ii(C)_"pe"] is the actual maximum photoelectric efficiency, or "quantum
efficiency" reported by the tube manufacturer, and does not include stem:[g_"c"], the
...
values for stem:[m], stem:[ii(C)_"pe"] and stem:[g] are given in <<tableIII-1>>. Of these three the stem:[g_"c"] value
is the most difficult to measure and it causes the greatest uncertainty in the phototube
response <<per70>>, <<per79>>.

[[tableIII-1]]
[cols="^,^,^"]
.Typical figures of merit for commercial counting system footnote:[Similar systems have been reported using EMI phototubes, e.g. EMI QB9635 for a commercial system <<sta74-2>>, and EMI 95145/A for a high-efficiency LS counting system <<ste67-1>>.] and for high-efficiency lS counting system for stem:[ii(E)_"e" = 5 "unitsml(keV)"]
|===
...
| vial volume | stem:[15 "unitsml(cm^3)"] | stem:[2.8 "unitsml(cm^3)"]
| vial material | glass | quartz
| | |
a| number of primary photons +
per stem:[5 "unitsml(keV)"] electron | 71 | 71
| stem:[ii(G)] value for each phototube | 0.11 | 0.18
| stem:[m] | 0.97 | 0.97
| stem:[ii(C)_"pe"] | 0.32 | 0.32
| stem:[g_"c"] | 0.80 | 0.80
a| stem:[ii(eta)]: stem:[5 "unitsml(keV)"] for each phototube footnote:[stem:[ii(eta)_0] values taken from <<figIII-2>> were corrected for ionization quenching using stem:[ii(Q)(ii(E)) = 0.63] (see <<figIV-6>>.] | 0.37 | 0.38
a| stem:[ii(epsilon)](^3^H) for two phototubes in coincidence | 62% | 73%
|===
...
efficiency, <<eqIII-3-1>> was solved for stem:[ii(G)], using the values for other parameters
...
figures of merit stem:[ii(eta)_0] in excess of 1 photoelectron/keV. The three are:
...
as FWHM/stem:[ii(E)_(alpha)])( (full width at half maximum divided by stem:[alpha]-particle energy), is 20 to
...
The NPL samples, for instance, consist of stem:[5 "unitsml(ml)"] of scintillator in a cylindrical
vial, while the NBS sources consist of stem:[3 "unitsml(ml)"] in a hemispherical vial.
...
and obtained stem:[ii(epsilon)](^3^H) = 73% for the tubes in coincidence, and 89% in
summation. These cells are available in both glass and quartz, with specified
light paths of from stem:[0.1 "unitsml(cm)"] to stem:[5 "unitsml(cm)"].

Although there are no data on the stem:[ii(epsilon)](^3^H) as a function of path length in these
...
vial, in which the stem:[ii(epsilon)](^3^H) for an unquenched sample was as high as 86%.
...
<<pal67>> are included here in <<figIII-5>>. They did not report stem:[ii(epsilon)](^3^H) directly,
so we cannot compare their results with those derived by the Monte-Carlo method.
The figures of merit stem:[ii(eta)_(49) "unitsml(keV)"] of about 0.3 photoelectron/keV for each tube suggest,
...
the stem:[alpha] or stem:[beta] particles. For the spherical vials it appears the stem:[5 "unitsml(ml)"] vial suggested
...
Nine vials of different diameters were used: stem:[10] to stem:[42 "unitsml(mm)"] corresponding to stem:[0.3]
to stem:[35 "unitsml(g)"] of scintillator.

. phototubes,
. scintillator solution stem:[7 "unitsml(g)"] PPO and stem:[50 "unitsml(mg)"] POPOP in 1 l dioxane,
. silicone oil,
. rubber seal,
...
also give a figure of merit stem:[ii(eta)_0] in excess of 1 photoelectron/keV for each
phototube.
...
so that an input of stem:[ii(E)"unitsml(keV)"] will produce, on average, a pulse of height stem:[bar(ii(V))] volts
with an uncertainty of (stem:[ii(sigma)_V] where stem:[ii(sigma)_V] can be 50 or 100% of stem:[bar(ii(V))]. In addition,
an input of stem:[2 ii(E)] will not necessarily produce an output of stem:[2 bar(ii(V))] because the_system
...
if totally converted into light at stem:[425 "unitsml(nm)"] (maximum emission of a typical scintillator),
...
in the scintillator will also reduce the efficiency of conversion into light. At stem:[5 "unitsml(keV)"]
this "ionization-quenching" effect <<bir64-1>> amounts to about 4%, so that
a mean number of about three photoelectrons will strike the first dynode for stem:[5 "unitsml(keV)"]
...
[stem]
++++
ii(P)_0 (bar(r),r) = e^(-bar(r)) ((bar(r))^r)/(r!).
++++
...
except at high energies (stem:[>500 "unitsml(keV)"]) where a simple Gaussian distribution gives
...
[stem]
++++
ii(P)_k(r,n) = (""^mk^r)/n sum_(i=0)^(n-1) (n-i) ii(P)_k(r,i) ii(P)_(k-1)(1,n-i)," for " n != 0", "k>1,
++++
...
[stem]
++++
ii(P)_k(1,0) = "exp"(-m_1) " exp" {m_k ii(P)_(k-1)(1,0)},
++++
...
stem:[ii(P)_k(1,0)] and stem:[ii(P)_k(r,0)] are the zero-detection probabilities and the generating
...
[stem]
++++
ii(P)_k(bar(r),n) = r/n sum_(i=0)^(n-1) (n-i)*ii(P)_k(r,i)*ii(P)_k(1,n-i)," for " n!=0," and "k >=1,
++++
...
[stem]
++++
ii(P)_k(bar(r),0) = "exp"(-bar(r))*"exp"{bar(r)* ii(P)_k(1,0)}.
++++
...
Mean:: stem:[ii(mu) = bar(r) * m_1 * m_2^(k-1),]

Variance:: stem:[ii(sigma)^2 = bar(r) * m_1^2 * m_2^(2(k-1)) {1+ (m_2)/(m_1(m_2-1))}.]
...
[stem]
++++
(ii(sigma)^2)/(ii(mu)^2) = 1/r {1+ (m_2)/(m_1(m_2-1))}.
++++
...
[stem%unnumbered]
++++
("FWHM")^2 = (ii(sigma)^2)/(ii(mu)^2) * 8 "ln" 2 = 8/(bar(r)) "ln" 2.
++++
...
[stem%unnumbered]
++++
ii(P)_k(bar(r),n) ~~ ii(P)_1(bar(r),n) = sum_(i=1)^(oo) ii(P)_0(bar(r),i) * ii(P)_0(bar(m_1i),n),
++++

where stem:[m_1] is the gain of the first stage and stem:[ii(P)_0] is the Poisson distribution as defined
by <<eqIV-2-1>>. Thus

[[eqIV-2-8]]
[stem]
++++
ii(P)_k(bar(r),n) ~~ ii(P)_0(bar(1),n)*"exp"(m_1-bar(r)) * sum_(i=1)^(oo) (i^n)/(i!) (bar(r))^i "exp"(-m_1i).
++++
...
stem:[380 "unitsml(keV)"]. The FWHM is 15.5%, which corresponds to a mean number of monos
of 231. In the actual determination of stem:[bar(r)], it is necessary to allow for the double
peak at stem:[368] and stem:[392 "unitsml(keV)"] and this partially accounts for the difference from
...
[stem]
++++
ii(P)_k^c (bar(r),n) ~~ sum_(i=2)^(oo) ii(P)_0 (bar(r),i) * ii(P)_0(bar(m_1i),n) * (1-2^(1-i)).
++++
...
number of discrete energy bands of mean energy, stem:[ii(E)_j], which, when multiplied
by the appropriate figure of merit (stem:[ii(eta)] electrons/keV, give a value of stem:[bar(r)] such that

[[eqIV-2-10]]
[stem]
++++
bar(r) = ii(eta) ii(E)_j.
++++

stem:[bar(r)] can be used with <<eqIV-2-7>> or <<eqIV-2-8>> and weighted according to the proportion
of the spectrum in the energy band stem:[ii(E)_j - Delta ii(E)//2] to stem:[ii(E)_j + Delta ii(E)//2]. The weighting factors,
stem:[ii(H)(j)], when integrated over the spectrum, are equal to unity. Thus the pulse-height
distribution is obtained from

[[eqIV-2-11]]
[stem]
++++
ii(S)(eta) = sum_(j=1)^J ii(H)(j) ii(P)(ii(eta) ii(E)_j,n),
++++

where stem:[ii(J)], the number of elements in the spectrum, is normally about twenty depending
upon the degree of precision required. There is little point in using element
widths, stem:[Delta ii(E)], much less than the resolution of the system. It should be noted that stem:[ii(eta)] is not independent of stem:[ii(E)] at low energies (see <<ionization_quenching>>.
...
can usefully be used to measure the figure of merit, stem:[ii(eta)], for the system and as was
...
stem:[beta]-ray emitters and values of stem:[ii(H)(j)], based upon this assumed spectrum, inserted into <<eqIV-2-11>>.

[[figIV-5]]
.Selected interactions for EC nuclides and a calculation of the efficiency for ^55^Fe in a coincidence system at figures or merit of stem:[ii(eta)_0 = 1.0] and stem:[0.5] photoelectron/keV <<gib72-2>> (courtesy Pergamon Press Ltd., Oxford).
image::img23.png[]
...
[stem%unnumbered]
++++
ii(E) = ii(E)_(gamma) [1+ii(E)_(gamma)//(m_0c^2)]^(-1),
++++

where stem:[ii(E)_(gamma)] equals the incident stem:[gamma]-ray energy and stem:[m_0c^2] is the rest mass of the
electron in appropriate energy units, such that stem:[ii(E)_(gamma)//m_0 c^2] is dimensionless.
...
also be divided up into energy bands, weighted by stem:[ii(H)(j)], and the output distribution
...
monos, will give the total of all detected events stem:[ii(N)]. As mentioned earlier, the
efficiency, stem:[ii(epsilon)], will not be 100% and it is now necessary to demonstrate how
it can be calculated so that stem:[ii(N)_0 = ii(N)//ii(epsilon)] can be deduced.
...
zero-detection probability, stem:[ii(Z)], is stem:[e^(-bar(r))] and the efficiency

[stem%unnumbered]
++++
ii(epsilon) = 1-ii(Z) = 1-e^(-bar(r)).
++++
...
summation as discussed in <<pulse_height_beta_ray>>, <<eqIV-2-11>>. The efficiency stem:[ii(epsilon)_1(beta)] for a single phototube is then given by

[[eqIV-3-1]]
[stem]
++++
ii(epsilon)_1(beta) = 1 - sum_(j=1)^J ii(H)(j) * "exp"{-ii(eta) * ii(E)(j)},
++++

where stem:[ii(eta)] is the figure of merit (photoelectrons/keV) and stem:[ii(E)] is the energy in stem:["unitsml(keV)"].

The spectral characteristics of most stem:[beta] emitters are known and calculation methods
based upon the Fermi theory can be used <<eva55>> to evaluate stem:[ii(H)(j)]. A similar
...
if the zero-detection probability for phototube stem:[ii(A)] is stem:[ii(Z)(a)] and for photofube stem:[ii(B)] is stem:[ii(Z)(b)], then the efficiency is

[stem%unnumbered]
++++
ii(epsilon)_"c" = {1-ii(Z)(a)} {1-ii(Z)(b)}
++++

[stem%unnumbered]
++++
= {1-ii(Z)(a)-ii(Z)(b)+ii(Z)(a+b)}
++++
...
[stem%unnumbered]
++++
ii(epsilon)_"c"(beta) = 1 - sum_(j=1)^J ii(H)_j {"exp" [-ii(eta)(a)ii(E)(j)] + "exp"[-ii(eta)(b)ii(E)(j)] - "exp" [(-ii(eta)(a) - ii(eta)(b)) * ii(E)(j)]},
++++

where stem:[ii(eta)(a)] and stem:[ii(eta)(b)] are the figures of merit for phototubes stem:[ii(A)] and stem:[ii(B)] respectively.
...
[stem%unnumbered]
++++
ii(N)_1 = ii(N)_0 * ii(epsilon)_1 = ii(N)_0 {1-ii(F)(a)},
++++

[stem%unnumbered]
++++
ii(N)_2 = ii(N)_0 * ii(epsilon)_2 = ii(N)_0 {1-ii(F)(b)} " and "
++++

[stem%unnumbered]
++++
ii(N)_"c" = ii(N)_0 * ii(epsilon)_"c" = ii(N)_0 {1-ii(F)(a)-ii(F)(b)+ii(F)(a+b)},
++++

where stem:[ii(F)(y) = sum_(j=1)^J ii(H)(j) "exp" [ii(eta)(y) ii(E)(j)\]], with stem:[y = a, b] or stem:[a + b].

Thus with the measured values stem:[ii(N)_1], stem:[ii(N)_2] and stem:[ii(N)_"c"] and three unknowns, stem:[a], stem:[b] and
stem:[ii(N)_0], Tissen <<tis58>> and, later, Kolarov et al. <<kol70>> suggested that stem:[ii(N)_0] could
be determined. However it is necessary to know the form of the summation stem:[ii(F)]
since for a stem:[beta]-ray spectrum stem:[ii(F)(a)* ii(F)(b) != ii(F)(a+b)].
...
energy in a very short track length (high stem:["d"ii(E)//"d"x]) as is observed for stem:[alpha] particles
...
[stem]
++++
("d"ii(L))/("d"x) = (ii(eta)_s "d"ii(E)//"d"x)/(1+k ii(B)" d" ii(E)//"d"x),
++++

where stem:["d"ii(E)//"d"x] is the specific energy loss (normally expressed in stem:["unitsml(MeV)"] stem:["unitsml(cm^-2*g^-1)"]),
stem:[k] is a rate constant and stem:[ii(B)"d"ii(E)//"d"x] is the concentration of ionizing events. Other
workers have included a further term stem:[ii(C)("d"ii(E)//"d"x)^2] in the denominator and Voltz <<vol69>>
proposed an equation of the form

[[eqIV-4-2]]
[stem]
++++
("d"ii(L))/("d"x) = ii(eta)_s ("d"ii(E))/("d"x) "exp" {- (k ii(B)"d" ii(E))/("d"x)}.
++++
...
the constant stem:[k ii(B)] is about stem:[9 "unitsml(mg*cm^-2*MeV^-1)"] and thus for stem:[beta] particles and electrons
with energies greater than about stem:[1 "unitsml(keV)"], where stem:["d"ii(E)//"d"x = 100 "unitsml(MeV*cm^-2*g^-1)"],
the <<eqIV-4-1>> and <<eqIV-4-2>> give similar results (stem:[53 ii(eta)_s] and stem:[40 ii(eta)_s], respectively).
Here stem:[ii(eta)_s] is defined as the figure of merit for the scintillator when stem:["d"ii(E)//"d"x] tends to
zero (i.e. high stem:[beta]-ray energies). If stem:[k ii(B) " d"ii(E)//"d"x] is small compared to 1, then the light
output from an electron of energy stem:[ii(E)] is

[[eqIV-4-3]]
[stem]
++++
ii(L) = ii(eta)_s int_0^R (("d"ii(E))/("d"x))"d"x = ii(eta)_s int_0^E "d"ii(E) = ii(eta)_s ii(E),
++++

and stem:[ii(eta)_s = ii(L)//ii(E)] is the light output per unit energy input. A second figure of merit for
the complete system is stem:[ii(eta)_0 = ii(lambda) ii(L)//ii(E)], where stem:[ii(lambda)] is the photocathode efficiency. In the
general case when stem:[k ii(B) " d"ii(E)//"d"x] is not small compared to 1, then

[stem%unnumbered]
++++
ii(L)(ii(E)) = ii(eta)_s int_0^E ("d"ii(E))/(1+k ii(B)" d"ii(E)//"d"x) = ii(eta)_s * ii(E) * ii(Q)(ii(E)),
++++

where stem:[ii(Q)(ii(E))] is obtained by numerical integration. Thus in general

[stem%unnumbered]
++++
ii(eta)_(E) = (ii(lambda) * ii(L)(ii(E)))/ii(E) = ii(eta)_0 ii(Q)(ii(E)).
++++

The shape of stem:[ii(Q)(ii(E))] is dependent upon the value chosen for stem:[k ii(B)] and an example with
stem:[k ii(B) = 9 "unitsml(mg*cm^-2*MeV^-1)"] is given in <<figIV-6>>, which was calculated using a modified
form of the Bethe-Bloch theory for stem:["d" ii(E)//"d"x] <<nel56>>, with stem:["d" ii(E)//"d"x] proportional
to stem:[ii(E)^(-0.5)] below stem:[400 "unitsml(eV)"] <<mar70-1>>.
...
It should be noted that for stem:[alpha] and other charged particles, when stem:[k ii(B)" d" ii(E)//"d"x > > 1],
<<eqIV-4-1>> reduces to

[stem%unnumbered]
++++
("d" ii(L))/("d"x) = ii(eta)_s/(k ii(B))
++++
...
[stem%unnumbered]
++++
ii(L) = (ii(eta)_s)/(k ii(B)) int_0^R "d"x = (ii(eta)_s)/(k ii(B)) * ii(R)(ii(E))
++++
...
in determining stem:[ii(eta)_0] at high electron energies is that a significant proportion of
...
[stem%unnumbered]
++++
ii(W)(ii(E)) = 1 -0.5{1/r + 1/h} ii(R)(ii(E)),
++++

where stem:[ii(R)(ii(E))] is the range of an electron of energy stem:[ii(E)] <<nel56>>. As far as possible
...
is only important in setting up a system. Illustrative values of stem:[ii(W)(ii(E))] are shown
in <<figIV-6>>.
...
circular cylinder of radius stem:[a = 10.5 "unitsml(mm)"] and half length, stem:[l = 27.75 "unitsml(mm)"], based upon
the following integral for the total probability of escape

[stem%unnumbered]
++++
ii(J)(ii(E)) = (int int e^(-ii(mu) d) "d" ii(Omega) "d" ii(V))/(int int "d" ii(Omega) "d"ii(V)),
++++

where the solid angle stem:["d" ii(Omega) = "sin" ii(theta) "d" ii(theta) "d" ii(Psi)] with the integral of stem:[ii(theta)] from stem:[0] to stem:[pi] and
stem:[ii(Psi)] from stem:[0] to stem:[pi] as well. The volume element stem:["d" ii(V) = x"d"x"d"z] <<figIV-7>> where the
...
to give stem:[pi a^2 l" "(= ii(V)//2)] and the numerator integral must be solved numerically
using tabulated values of the mass attenuation coefficient, stem:[ii(mu)_"a"], for different photon
...
--
[align=left]
stem:[ii(mu)_"a" d = ii(mu)_"a" (l-z) "cos" ii(theta)], +
with integration limits for stem:[ii(theta)] from stem:[ii(theta) = 0] to stem:[ii(theta) = ii(theta)_1 = "tan"^(-1) {(-x "cos" ii(Psi) +- f)/(1-z)}],
--
. curved section,
+
--
[align=left]
stem:[ii(mu)_"a" d = - ii(mu)_"a" (x"cos" ii(Psi) +- f)// "sin" ii(theta)], +
with integration limits for stem:[ii(theta)] from stem:[ii(theta) = ii(theta)_1] to stem:[ii(theta) = ii(theta)_2 = "tan"^(-1){(-x"cos" ii(Psi) +- f)/(-1-z)}],
--
. bottom of the cylinder,
+
--
[align=left]
stem:[ii(mu)_"a" d = - ii(mu)_"a"(1+z)//"cos" ii(theta)], +
with integration limits for stem:[ii(theta)] from stem:[ii(theta) = ii(theta)_2] to stem:[ii(theta) = pi].
--
...
The limits for stem:[ii(Psi)] are stem:[0] to stem:[pi], for stem:[x] from stem:[0] to stem:[a] and for stem:[z] from stem:[0] to stem:[1]. The function
stem:[f] above is given by

[stem%unnumbered]
++++
f = (a^2 - x^2 "sin"^2 ii(Psi))^(1//2).
++++

The value of stem:[1 - ii(J)(ii(E))] for a stem:[15 "unitsml(cm^3)"] volume with stem:[a = 10.5 "unitsml(mm)"] and stem:[l = 21.75 "unitsml(mm)"]
is plotted as function of energy in <<figIV-8>> and shows that this correction is
important above about stem:[2 "unitsml(keV)"]. The efficiency for counting Auger electrons is
also shown in this figure for two values of the figure of merit, stem:[ii(eta)_0 = 0.5] and
1.0 photoelectron/keV (stem:[ii(eta)_0//2] for each phototube).
...
Thus the figure of merit, stem:[ii(eta)_0], is reduced to stem:[g ii(eta)_0]. Colour quenching introduces
...
must be avoided. Dead times in excess of stem:[100 "unitsml(ns)"] may be required to avoid this problem.
...
the ionization quenching constant stem:[k ii(B)] in <<eqIV-4-1>>. Any changes in the system
or the scintillator will involve a remeasurement of stem:[k ii(B)].
...
less than the zero-detection probability, stem:[ii(Z)], and will depend upon the systematic
uncertainties in the ionization-quenching constant, stem:[k ii(B)], and the high-energy figure
of merit, stem:[ii(eta)_0]. Some uncertainty must be placed upon the knowledge of the spectrum
...
The zero-detection probability stem:[ii(Z)] is approximately equal to stem:[e^(-bar(r))], where stem:[bar(r) = ii(eta) ii(E)].
Thus stem:["d"ii(Z)//ii(Z) = -"d"bar(r) = -"d"eta * ii(E)] or the fractional uncertainty in stem:[ii(Z)] is proportional to
the uncertainty in ill, the figure of merit. Also the fractional uncertainty in the
counting efficiency stem:[ii(epsilon)], is stem:["d"ii(Z)//ii(epsilon)] so that, if a 5-keV electron in the scintillator
produces three photoelectrons at the first dynode (stem:[ii(eta)_0 ii(Q)(ii(E)) = 1 xx 0.63]), assuming
that stem:[ii(eta)] is measured to stem:[+-10%] (standard deviation), then

[stem%unnumbered]
++++
("d"ii(Z))/ii(epsilon) = (0.1*3*e^(-3))/(1-e^(-3)) = 1.6%.
++++
...
the use of the whole spectrum to produce a weighted value of stem:["d"ii(Z)//ii(E)] and also
a better assessment of stem:["d" ii(eta)] and the other variables.
...
nearly 0.32 photoelectron per photon at stem:[385 "unitsml(nm)"] for a bialkali photocathode.
...
a larger aliquot in a large quantity of scintillator (stem:[50] to stem:[100 "unitsml(cm^3)"]) and then
...
of radionuclides of maximum energy lower than stem:[200 "unitsml(keV)"], a detection efficiency
...
the basis of an average of one photoelectron per stem:[1.5 "unitsml(keV)"] of energy dissipated
in the scintillator.
...
less than about stem:[100 "unitsml(keV)"]. Birks <<bir51>> has given a formula describing the phenomenon
...
by the introduction of a term dependent on the energy, stem:[ii(Q)(ii(E))], when calculating
...
value of stem:[ii(Q)(ii(E))] for an energy of stem:[5 "unitsml(keV)"]. The quality parameter measured on their
...
below stem:[0.5 "unitsml(keV)"] for organic solvents. This results in an error which is difficult to
...
organic scintillators <<hor64-2>> is inaccurate, particularly below stem:[20 "unitmsl(keV)"]. There
...
Whilst for a proportional counter this sensitivity stem:[ii(epsilon)_(beta_gamma)] is several parts in
...
than 95% for stem:[beta] radiation of energy greater than about stem:[5 "unitsml(keV)"], and this is a very
...
stem:[gamma_9] (stem:[1365 "unitsml(keV)"]) in coincidence with stem:[beta]'s of lower energy, stem:[gamma_5] (stem:[796 "unitsml(keV)"]) in coincidence
...
(stem:[604.7 "unitsml(keV)"]), in coincidence with three stem:[beta] branches. The same authors have carried
...
The sharpness of the peaks in the afterpulse distribution below stem:[1 "unitsml(us)"] has been
...
prompt afterpulse (at about stem:[0.3 "unitsml(us)"] at typical voltages) which is observed in
...
no afterpulses. Shin <<shi68>> also observed afterpulses in the region below stem:[1 "unitsml(us)"]
...
afterpulses at 0.8 and stem:[4 "unitsml(us)"], following single photoelectron events, and suggested
...
up to stem:[15 "unitsml(us)"] after the main pulse, with an intensity correlated to the main pulse,
...
a variable discriminator, it was found that if any region (above about stem:[1 "unitsml(us)"]) of
...
dynodes was found, which occurred about stem:[40] and stem:[80 "unitsml(ns)"] after the main pulse.
...
EMR phototubes recorded afterpulses decaying with a lifetime of up to stem:[2 "unitsml(ms)"] and
...
excited by ^60^Co, and observed a slow component of order stem:[0.1 "unitsml(us)"] for toluene
...
liquid scintillators, Kuchnir <<kuc68>> observed slow components of order stem:[0.5 "unitsml(us)"],
...
stem:[gamma]-ray-induced phosphorescence (stem:[ii(tau) < 30 "unitsml(s)"]) at discrimination levels equivalent
to one photoelectron.

With electron excitation, Owen <<owe59>> observed a slow component in oxygen-free
liquid scintillators with a time constant of the order of stem:[1 "unitsml(us)"], and Horrocks
<<hor70-1>> gives time constants of about stem:[0.25 "unitsml(us)"]. The relative intensities of the
...
<<bir64-1>> (stem:[<= 0.1%] that of the main pulse after stem:[1 "unitsml(us)"]) and they can be avoided
...
In the region below stem:[100 "unitsml(us)"], the degree of afterpulsing can be readily observed
by variation of the dead time, and such experiments at NPL indicate that a dead
time of at least stem:[10 "unitsml(us)"] is required to reduce these spurious pulses to well below
...
In the stem:[10 "unitsml(us)"] to stem:[100 "unitsml(ms)"] range a correlation technique <<gol55>> has been used
...
about stem:[10 "unitsml(ms)"] of the main pulse. <<figVI-4>> shows the stem:[beta]-particle count rate as
a function of counting efficiency, stem:[ii(epsilon)_beta], both with and without this correction for
...
Afterpulses with lifetimes greater than stem:[100 "unitsml(ms)"] could also occur, but since NPL
...
to the end-point energy, at least for end-point energies above about stem:[300 "unitsml(keV)"]
(which corresponds to a discriminator level in the region of stem:[10 "unitsml(keV)"]). The discriminator
level can rarely be reduced much below that corresponding to stem:[10 "unitsml(keV)"],
...
[[tableVII-l]]
[cols="<,^,^,^,^,^"]
.Decay data of ^134^Cs (intensities stem:[>= 0.10%]) stem:[beta^-] decay to ^134^Ba; stem:[ii(T)_(1//2) = (2.062 +- 0.005) a]
|===
...
.3+| X ray | stem:[ii(K) alpha_2] | 31.8171 | 0.0003 | 0.213 | 0.009
^| stem:[ii(K) alpha_1] | 32.1936 | 0.0003 | 0.393 | 0.015
^| stem:[ii(K) beta] | 36.4 | | 0.143 | 0.006
...
(one) | RCA 31000D +
(one)
| stem:[beta]-dead time (stem:["unitsml(us)"beta]) | 5.0 | 1.2 | live timer used | 24.0
| stem:[gamma]-dead time (stem:["unitsml(us)"gamma]) | 5.0 | 1.1 to 3.7 | 1.4 to 2.0 | 1.7 to 4.4
| Resolving time stem:["unitsml(us)"] | 1.0 | 0.5 | 1.8 | 0.2
...
integral measurements above a stem:[gamma]-ray-energy threshold of stem:[500 "unitsml(keV)"]. The usual
technique of stem:[beta]-particle detection-efficiency extrapolation <<bae73>> was used for
each window, i.e. if the count rates per unit mass (stem:["unitsml(s^-1*mg^-1)"], corrected for dead-time
losses, half lives, background, etc.) are stem:[ii(N)_beta], stem:[ii(N)_gamma] and stem:[ii(N)_"c"], then

[stem%unnumbered]
++++
ii(N)_beta // ii(epsilon)_beta = ii(N)_0 + alpha_1(1- ii(epsilon)_beta) // ii(epsilon)_beta + alpha_2 (1-ii(epsilon)_beta)^2 // ii(epsilon)_beta^2 + ...,
++++

where stem:[ii(epsilon)_beta = ii(N)_"c" // ii(N)_gamma], and hence the disintegration rate stem:[ii(N)_0] is the extrapolated
value of stem:[ii(N)_beta // ii(epsilon)_beta] at stem:[ii(epsilon)_beta = 1].
...
The values of stem:[ii(N)_0] (on 1977-02-01, 00 h UT) with the range of stem:[beta]-detection efficiencies
...
.Results
|===
.2+| .2+a| Coincident stem:[ii(E)_gamma] or stem:[Delta ii(E)_gamma] (MeV) .2+a| Range of stem:[ii(N)_"c"//ii(N)_gamma] .2+a| stem:[ii(N)_0] (stem:["unitsml(Bq)"*"unitsml(mg)"^(-1)]) 2+a| Percent. uncertainty .2+a| Degree of fit
a| random (stem:[1 rm(sigma)]) a| systematic
...
All the quoted results for stem:[ii(N)_0] by LS counting are self-consistent within the quoted
uncertainties, and are in good agreement with stem:[ii(N)_0] obtained by stem:[4pi beta("PC")-gamma]
...
* [[[hor64-2,1]]], D.L. Horrocks, Pulse height-energy relationship of a liquid scintillator for electrons of energy less than stem:[100 "unitsml(keV)"], Nucl. Instr. and Meth. *30*, 157.
