...
stem:[n_"D" = 1.50] and a kinematic viscosity of stem:[1.15 "unitsml(cm^2*s^-l)"] <<dow79>>.
...
each window, i.e. if the count rates per unit mass (stem:["unitsml(s^-l*mg^-1)"], corrected for dead-time
