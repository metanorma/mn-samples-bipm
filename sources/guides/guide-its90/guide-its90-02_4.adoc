...
* [[[StrouseFurikawa1999,1]]] Strouse G, Furukawa G T 1999 Thermal Characteristics of the NIST Fixed-Point Cells, Furnaces, and Maintenance Baths Over the Temperature Range from stem:[83.8058 "unitsml(K)"] to stem:[1234.93 "unitsml(K)"], Proc. 7^th^ International Symposium on Temperature and Thermal Measurements in Industry and Science (TEMPMEKO '99), pp. 153-158
