...
where stem:["d"ii(T)//"d"h] is the hydrostatic pressure coefficient defined by the ITS-90, i.e. stem:[-0.73 * 10^{-3} "unitsml(Km^-1)"]. The difference in vertical elevation between the liquid surface stem:[h_{"1iq"}] and the thermal centre of the SPRT sensing element stem:[h_{"SPRT"}] amounts to stem:[200] to stem:[300 "unitsml(mm)"], depending on the size of the cell, translating into a hydrostatic pressure correction of stem:[150 "unitsml(uK)"] to stem:[220 "unitsml(uK)"].
